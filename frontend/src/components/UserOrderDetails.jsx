      ...
      {data &&
        data?.cart.map((item, index) => {
          ...
          <div className="w-full flex items-start mb-5" key={index}>
            ...
            {/* 🔧 FIX: set selectedItem BEFORE opening the modal, and do it
                explicitly (not via the `||` short-circuit trick) so we never
                submit a review with a stale/null selectedItem */}
